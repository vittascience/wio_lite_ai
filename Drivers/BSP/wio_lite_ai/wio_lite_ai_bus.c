...
static osSemaphoreId BspI2c1Semaphore = 0;
static osSemaphoreId BspI2c4Semaphore = 0;
#endif
...
/** @defgroup STM32H7B3I_DK_BUS_Private_Functions Private Functions
  * @{
  */
/**
...
static void I2C1_MspInit(I2C_HandleTypeDef *phi2c)
{
  ...
  HAL_NVIC_SetPriority(BUS_I2C1_ER_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(BUS_I2C1_ER_IRQn);
  HAL_NVIC_SetPriority(BUS_I2C1_EV_IRQn, 0, 0);
...
static void I2C4_MspInit(I2C_HandleTypeDef *phi2c)
{
  ...
  HAL_NVIC_SetPriority(BUS_I2C4_ER_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(BUS_I2C4_ER_IRQn);
  HAL_NVIC_SetPriority(BUS_I2C4_EV_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(BUS_I2C4_EV_IRQn);
